...
public class TransactionServiceProcessingTest {
    ...
    void testProcessTransactionSameCurrency() {
        ...
        CreateTransactionDto createTransactionDto = TransactionObjectMother.generateBasicCreatePaymentDto();

        // Act
        Transaction transaction = transactionService.processTransaction(fromAccount, toAccount, amount, createTransactionDto);
    ...
    void testProcessTransactionRsdToForeign() {
        ...
        when(exchangeRateService.convertCurrency(amount, Currency.Code.RSD, Currency.Code.USD)).thenReturn(BigDecimal.valueOf(1));
        ...
        when(bankAccountServiceImpl.getBankAccountForCurrency(Currency.Code.RSD)).thenReturn(rsdBankAccount);
        when(bankAccountServiceImpl.getBankAccountForCurrency(Currency.Code.USD)).thenReturn(usdBankAccount);
    ...
    void testProcessTransactionForeignToRsd() {
        ...
        when(exchangeRateService.calculateFee(amount)).thenReturn(BigDecimal.valueOf(10));
        when(exchangeRateService.convertCurrency(amount, Currency.Code.USD, Currency.Code.RSD)).thenReturn(BigDecimal.valueOf(1000));
    ...
    void testProcessTransactionForeignToForeign() {
        ...
        when(exchangeRateService.calculateFee(amount)).thenReturn(BigDecimal.valueOf(10));
        when(exchangeRateService.convertCurrency(amount, Currency.Code.EUR, Currency.Code.RSD)).thenReturn(BigDecimal.valueOf(1000));
        when(exchangeRateService.convertCurrency(BigDecimal.valueOf(1000), Currency.Code.RSD, Currency.Code.USD)).thenReturn(BigDecimal.valueOf(1));
        ...
        when(bankAccountServiceImpl.getBankAccountForCurrency(Currency.Code.EUR)).thenReturn(eurBankAccount);
        when(bankAccountServiceImpl.getBankAccountForCurrency(Currency.Code.RSD)).thenReturn(rsdBankAccount);
        when(bankAccountServiceImpl.getBankAccountForCurrency(Currency.Code.USD)).thenReturn(usdBankAccount);
